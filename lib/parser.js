    ...
    return {
        ...
        parseRazorToken: function(loopIterator) {
            ...
            if (loopIterator.currentChar() == '{' || loopIterator.currentChar() == '(') {
                ...
                do {
                    if (!loopIterator.currentChar().match(this.asciiIdentigier) &&
                        !loopIterator.currentChar().match(/[\.\@]/) &&
                        !loopIterator.currentChar().match(this.identifierExpression)) {
                        break;
                    }
                ...
                if (token == '@') {
                    ...
                    return this.createRazorSection("renderBody();");
                } else {
